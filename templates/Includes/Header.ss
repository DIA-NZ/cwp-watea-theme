    ...
    <div class="container site-header">
        ...
        <div class="site-header-brand">
            <a title="<%t CWP_Header.Title "Go to Home Page" %>" class="site-header-brand-link-default" href="$BaseHref">
                <% if $SiteConfig.Brandmark %>
                    <img
                        src="$SiteConfig.Brandmark.URL" width="$SiteConfig.Brandmark.Width" height="$SiteConfig.Brandmark.Height"
                        alt="$SiteConfig.Title - Brandmark" class="brandmark"
                        aria-hidden="true" />
                <% end_if %>
                <% if $SiteConfig.Logo %>
                    <img
                        src="$SiteConfig.Logo.URL" width="$SiteConfig.Logo.Width" height="$SiteConfig.Logo.Height"
                        alt="$SiteConfig.Title" class="logo"
                        aria-hidden="true" />
                <% else %>
